...
class SagittalView2DComponent {
    constructor(containerId, options = {}) {
        ...
        this.viewPlane = 'Sagittal';         // 视图平面：Axial, Coronal, Sagittal
...
renderToolbar() {
        return `
            <div class="cross-section-view2d-toolbar">
                <div class="toolbar-title">Sagittal</div>
...
// 导出到全局
window.SagittalView2DComponent = SagittalView2DComponent;
