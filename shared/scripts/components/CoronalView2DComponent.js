...
class CoronalView2DComponent {
    constructor(containerId, options = {}) {
        ...
        this.viewPlane = 'Coronal';         // 视图平面：Axial, Coronal, Sagittal
...
renderToolbar() {
        return `
            <div class="cross-section-view2d-toolbar">
                <div class="toolbar-title">Coronal</div>
...
// 导出到全局
window.CoronalView2DComponent = CoronalView2DComponent;
