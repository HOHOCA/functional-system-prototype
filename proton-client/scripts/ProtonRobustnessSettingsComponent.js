class ProtonRobustnessSettingsComponent {
    constructor(options = {}) {
        this.options = {
        ...
        this.modalEl.innerHTML = `
            <div class="create-robustness-evaluation-dialog" role="dialog" aria-modal="true">
                ...
                <div class="create-robustness-evaluation-footer">
                    ...
                    <button class="cre-btn primary" data-role="confirm">确定</button>
                </div>
            </div>
        `;
...
if (typeof window !== 'undefined') {
    window.ProtonRobustnessSettingsComponent = ProtonRobustnessSettingsComponent;
}
